...
* Added a new built-in action named `Apply filters from group layers` that adds filters (layer effects) from all parent group layers to the current layer. This action is available for Export Layers and Edit Layers (#87).
