...
* If [G'MIC](https://gmic.eu/) is installed as a GIMP plug-in, a built-in action `G'MIC filter` will now be available that simplifies applying a filter from G'MIC non-interactively.
