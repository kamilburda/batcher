...
_PLACEHOLDERS_LIST = [
  ...
  ('background_layer', _('Layer Above (Background)'), get_background_layer),
  ('background_layer_for_array', _('Layer Above (Background)'), get_background_layer_for_array),
  ('foreground_layer', _('Layer Below (Foreground)'), get_foreground_layer),
  ('foreground_layer_for_array', _('Layer Below (Foreground)'), get_foreground_layer_for_array),
