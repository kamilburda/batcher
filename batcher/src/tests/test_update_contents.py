...
@mock.patch('batcher.update._remove_obsolete_pygimplib_files_3_3_2')
@mock.patch('batcher.update._remove_obsolete_plugin_files_3_3_2')
@mock.patch('batcher.update._try_remove_file')
