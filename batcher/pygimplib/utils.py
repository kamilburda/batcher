...
def safe_encode(str_: Optional[str], encoding: str) -> bytes:
  """Returns bytes encoded using the specified encoding.
...
def safe_encode_gimp(str_: Optional[str]) -> bytes:
  """Returns encoded bytes suitable for the GIMP API.
...
def safe_decode(bytes_: Optional[bytes], encoding: str) -> str:
  """Returns a string decoded using the specified encoding.
...
def safe_decode_gimp(bytes_: Optional[bytes]) -> str:
  """Returns a decoded string suitable for the GIMP API.
