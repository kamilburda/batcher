...
class TestPersistor(unittest.TestCase):
  ...
  def test_set_default_setting_sources_none(self, mock_gimp_module):
    persistor_.Persistor.set_default_setting_sources(None)
    self.assertEqual(persistor_.Persistor.get_default_setting_sources(), collections.OrderedDict())
  
  def test_set_default_setting_sources_raises_error_on_invalid_input(self, mock_gimp_module):
    with self.assertRaises(TypeError):
      persistor_.Persistor.set_default_setting_sources(['persistent'])
  
  def test_get_default_setting_sources_returns_copy(self, mock_gimp_module):
  ...
  def test_load_save(self, mock_gimp_module):
    self._test_load_save(self.sources_for_persistor)
  
  def test_load_save_with_default_sources(self, mock_gimp_module):
    persistor_.Persistor.set_default_setting_sources(self.sources_for_persistor)
    
    self._test_load_save(None)
  
  def test_load_save_with_default_sources_as_dict_of_lists(self, mock_gimp_module):
  ...
  def test_load_save_with_default_sources_and_dict(self, mock_gimp_module):
    session_source = stubs_sources.StubSource('', 'session')
  ...
  def test_load_save_with_default_sources_and_dict_of_lists(self, mock_gimp_module):
    session_source = stubs_sources.StubSource('', 'session')
  ...
  def test_load_save_with_default_sources_and_list(self, mock_gimp_module):
    self._spy_for_source(self.persistent_source)
    self._spy_for_source(self.session_source)
  ...
  def test_load_combine_settings_from_multiple_sources(self, mock_gimp_module):
    self.settings['file_extension'].set_value('png')
    self.settings['flatten'].set_value(True)
  ...
  def test_load_multiple_setting_groups(self, mock_gimp_module):
  ...
  def test_load_empty_settings(self, mock_gimp_module):
  ...
  def test_load_no_default_source(self, mock_gimp_module):
    result = persistor_.Persistor.load([self.settings], None)
    self.assertEqual(result.status, persistor_.Persistor.FAIL)
  
  def test_load_missing_default_source_from_list(self, mock_gimp_module):
  ...
  def test_load_settings_source_not_found(self, mock_gimp_module):
  ...
  def test_load_settings_not_found(self, mock_gimp_module):
  ...
  def test_load_child_settings_not_found_in_first_but_subsequent_sources(self, mock_gimp_module):
    settings = stubs_group.create_test_settings_hierarchical()
  ...
  def test_load_fail_for_one_source(self, mock_gimp_module):
  ...
  def test_load_fail_for_all_sources(self, mock_gimp_module):
    persistor_.Persistor.save([self.settings], self.sources_for_persistor)
  ...
  def test_save_empty_settings(self, mock_gimp_module):
    result = persistor_.Persistor.save([], self.session_source_for_persistor)
    self.assertEqual(result.status, persistor_.Persistor.NO_SETTINGS)
  
  def test_save_no_default_source(self, mock_gimp_module):
    result = persistor_.Persistor.save([self.settings], None)
    self.assertEqual(result.status, persistor_.Persistor.FAIL)
  
  def test_save_missing_default_source_from_list(self, mock_gimp_module):
    persistor_.Persistor.set_default_setting_sources(self.session_source_for_persistor)
  ...
  def test_save_fail_for_one_source(self, mock_gimp_module):
    self.session_source.read_data_from_source = mock.Mock(
      wraps=self.session_source.read_data_from_source)
    self.session_source.read_data_from_source.side_effect = sources_.SourceInvalidFormatError
  ...
  def test_save_fail_for_all_sources(self, mock_gimp_module):
    self.session_source.read_data_from_source = mock.Mock(
      wraps=self.session_source.read_data_from_source)
    self.session_source.read_data_from_source.side_effect = sources_.SourceInvalidFormatError
...
class TestLoadSaveFromSettingsAndGroups(unittest.TestCase):
  ...
  def test_load_save_setting(self, mock_gimp_module):
  ...
  def test_load_setting_has_no_effect_if_setting_has_ignore_tag(self, mock_gimp_module):
  ...
  def test_load_save_group(self, mock_gimp_module):
    self.settings['main/file_extension'].set_value('jpg')
    self.settings['advanced/flatten'].set_value(True)
    self.settings['advanced/use_layer_size'].set_value(True)
  ...
  def test_load_group_has_no_effect_if_group_has_ignore_tag(self, mock_gimp_module):
...
class TestLoadSaveEvents(unittest.TestCase):
  ...
  def test_before_load_event(self):
  ...
  def test_after_load_event(self):
  ...
  def test_after_load_event_not_all_settings_found_invoke_for_all_settings(self):
    self.setting.set_value('gif')
  ...
  def test_after_load_event_is_triggered_even_after_fail(self):
    self.flatten.set_value(True)
    persistor_.Persistor.save([self.setting, self.flatten], self.session_source_dict)
  ...
  def test_after_save_event_is_triggered_even_after_fail(self):
    self.setting.set_value('gif')
    self.setting.connect_event(
      'after-save', stubs_setting.on_file_extension_changed, self.flatten)
  ...
  def test_events_are_triggered_for_groups_including_top_group(self):
    settings = stubs_group.create_test_settings_hierarchical()
  ...
  def test_event_triggering_is_not_enabled(self):
    self.setting.set_value('gif')
