...
1. **On Windows, GIMP 3.0.0-1 or later is required. GIMP 3.0.0 is not supported.** There was originally an issue that prevented several plug-ins, including Batcher, from working. You can check the installed GIMP version in `Help → About GIMP`.
